...
1. Fork this [repo](https://github.com/theburningmonk/production-ready-serverless-slsdays-rome-demo)
...
In the `serverless.yml`, go to ln 5 and replace `<INSERT EMAIL HERE>` with your work email.
...
Open the first `GET` endpoint in the browser.
